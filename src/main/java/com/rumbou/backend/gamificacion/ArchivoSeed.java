...
final class ArchivoSeed {
    ...
    static List<com.rumbou.backend.gamificacion.ArchivoSeed.Fila> leer(String archivo, int columnasEsperadas) {
        ClassPathResource recurso = new ClassPathResource(CARPETA_SEED + archivo);
        List<com.rumbou.backend.gamificacion.ArchivoSeed.Fila> filas = new ArrayList<>();
        ...
        try (BufferedReader lector = new BufferedReader(
            ...
            while ((linea = lector.readLine()) != null) {
                ...
                com.rumbou.backend.gamificacion.ArchivoSeed.Fila fila = new com.rumbou.backend.gamificacion.ArchivoSeed.Fila(archivo, numeroLinea, linea.split(SEPARADOR, -1));
